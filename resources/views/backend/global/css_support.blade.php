<head>
    ...
    <title>@yield('title', 'Movie -Admin Dashboard')</title>
    <!-- Favicon icon -->
    ...
    <link rel="stylesheet" href="{{ asset('backend/vendor/jquery-steps/css/jquery.steps.css') }}">
    ...
    <!-- Pick date -->
    <link href="{{ asset('backend/vendor/pickadate/themes/default.date.css') }}" rel="stylesheet">
